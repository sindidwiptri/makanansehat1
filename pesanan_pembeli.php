...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>Makanan</strong> Sehat</a>
  ...
  <!-- Menu -->
    <div class="container">
      ...
      <form method="POST" action="">
        ...
        <a href="cetak.php" class="btn btn-primary btn-sm">Cetak Laporan</a>
      </form>        
